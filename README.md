...
<p>
Sou estudante de desenvolvimento web há dois anos e programar além de ter se transformado em uma profissão, continua sendo um dos meus mais preferidos hobbys, sendo que alguns deles são: <i>“desenhar, escrever, ensinar, aprender e curtir a família”</i>. 
...
* Ofir ( PHP ) <a href="https://github.com/valdiney/Ofir" target="_blank" title="Visualize o projeto">( Link )</a> <i>Mini-framework</i>
...
* PesoIdeal_app ( JS ) <a href="https://github.com/valdiney/pesoIdeal_app" target="_blank" title="Visualize o projeto">( Link )</a> </a> <i>IMC para Android</i>
